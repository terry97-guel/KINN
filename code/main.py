...
from utils.initalize import INITALZE_EVEN_JOINTS, SET_TPOSE
...
def main(args:Union[PRIMNET_ARGS_TEMPLATE, FC_PRIMNET_ARGS_TEMPLATE, PCC_PRIMNET_ARGS_TEMPLATE]):
    ...
    ### DATALOADER ###
    train_dataset,val_dataset,test_dataset,ext_dataset  = get_dataset(f"dataset/{args.DATASET}.json")
    ...
    for batch in tqdm(train_sampler):
        train_log_dict = update_primnet(model, batch, train_sampler, args, TRAIN = True)
...
if __name__ == "__main__":
    ...
    parser.add_argument("--configs", default="PRIMNET/FINGER.py",type=str) # [FC_PRIMNET, PRIMNET, PCC_PRIMNET]
