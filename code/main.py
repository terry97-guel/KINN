...
if __name__ == "__main__":
    ...
    parser.add_argument("--configs", default="FC_PRIMNET/FINGER.py",type=str) # [FC_PRIMNET, PRIMNET, PCC_PRIMNET, PRIMNET_FULL] # [FINGER, ABAQUS_32, ELASTICA]
    ...
    ask_and_make_folder(SAVEPATH, ask = True)
